...
def main():
    ...
    for model_type in model_types.keys():
        ...
        retrieval_results, gestures_info_exploded = manual_implementation_object_retrieval(pretrained_model , processed_keypoints_dict, mirrored_keypoints_dict, sekeleton_backbone='jointsformer', gestures_and_speech_info=gestures_info_exploded, modalities=model_types[model_type]['modalities'], audio_dict=audio_dict,model_type=model_type)
