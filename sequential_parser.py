...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='configs/pretraining/unimodal/train_ssl_contrastive_masked_jointsformer.yaml',
    ...
    parser.add_argument(
        ...
        default='configs/augmentations/skeleton_simple_aug.yaml',
    ...
    # add sim_coeff: 25, std_coeff: 25, cov_coeff: 1
    parser.add_argument(
        '--sim_coeff',
        default=25,
    ...
    parser.add_argument(
        '--std_coeff',
        default=25,
        help='standard deviation coefficient',
        type=float
    )
    parser.add_argument(
        '--cov_coeff',
        default=1,
        help='covariance coefficient',
        type=float
    )
    parser.add_argument(
        '--mask_ratio',
